    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='students', related_query_name='person', to='school.school')),
            ],
            options={
                'verbose_name': 'student',
                'verbose_name_plural': 'students',
                'ordering': ['-first_name'],
                'indexes': [models.Index(fields=['first_name', 'last_name'], name='students_st_first_n_e9466d_idx'), models.Index(fields=['registration_code'], name='students_st_registr_91b46f_idx'), models.Index(fields=['date_of_birth'], name='students_st_date_of_a50842_idx')],
            },
        ),
    ]
