...
class Fee(models.Model):
    ...
    fee_description = models.TextField(max_length=100, null=True, blank=True, verbose_name='Fee Description')
    ...
    fee_payment_description = models.TextField(max_length=100, null=True, blank=True, verbose_name='Fee Payment Description')
    ...
    class Meta:
        ...
        unique_together = ['fee_name', 'fee_amount', 'fee_date', 'fee_class', 'fee_student', 'fee_status', 'fee_description', 'fee_payment_method', 'fee_payment_date', 'fee_payment_amount', 'fee_payment_status', 'fee_payment_description']
        db_table = 'fees'